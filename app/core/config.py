...
class Settings(BaseSettings):
    ...
    REPORT_SPRING_WEBHOOK_URL: str = "http://spring-server:8080/internal/v1/reports/callback"
    QUESTION_SPRING_WEBHOOK_URL: str = "http://spring-server:8080/internal/v1/questions/callback"
